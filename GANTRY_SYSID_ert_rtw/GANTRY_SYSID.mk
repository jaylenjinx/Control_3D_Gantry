###########################################################################
## Makefile generated for component 'GANTRY_SYSID'. 
## 
## Makefile     : GANTRY_SYSID.mk
## Generated on : Wed Oct 16 12:57:12 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/GANTRY_SYSID.elf
...
COMPILER_COMMAND_FILE     = GANTRY_SYSID_comp.rsp
CMD_FILE                  = GANTRY_SYSID.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/GANTRY_SYSID.elf
...
OBJS = MW_AnalogInput.o MW_digitalIO.o MW_PWM.o xcp_ext_mode.o GANTRY_SYSID.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o mw_mbed_interface.o BufferedSerial.o stm32f7xx_init_board.o MW_Timer.o mbed_syscalls.o SysTickScheduler.o m3m4m4f_multitasking.o sys_arch.o rtiostream_serial_dma.o mw_mbed_pintable_interface.o xcp_platform_timer_mbed.o
...
LDFLAGS_ = @C:\Users\Jaylen\DOCUME~1\MATLAB\BigGanch\GANTRY~1\MBED_O~1.RSP
...
SHAREDLIB_LDFLAGS_ = @C:\Users\Jaylen\DOCUME~1\MATLAB\BigGanch\GANTRY~1\MBED_O~1.RSP
...
CPP_LDFLAGS_ = @C:\Users\Jaylen\DOCUME~1\MATLAB\BigGanch\GANTRY~1\MBED_O~1.RSP
...
CPP_SHAREDLIB_LDFLAGS_ = @C:\Users\Jaylen\DOCUME~1\MATLAB\BigGanch\GANTRY~1\MBED_O~1.RSP
...
%.o : $(START_DIR)/GANTRY_SYSID_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/GANTRY_SYSID_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/GANTRY_SYSID_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/GANTRY_SYSID_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/GANTRY_SYSID_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_digitalIO.o : C:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/mbed/src/MW_digitalIO.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


MW_PWM.o : C:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/mbed/src/MW_PWM.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
GANTRY_SYSID.o : $(START_DIR)/GANTRY_SYSID_ert_rtw/GANTRY_SYSID.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/GANTRY_SYSID_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
rtiostream_serial_dma.o : C:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/stmnucleo/src/rtiostream_serial_dma.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


mw_mbed_pintable_interface.o : C:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/mbed/src/mw_mbed_pintable_interface.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
