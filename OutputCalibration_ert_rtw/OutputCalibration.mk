...
PRODUCT_NAME              = OutputCalibration
MAKEFILE                  = OutputCalibration.mk
...
COMPILER_COMMAND_FILE     = OutputCalibration_comp.rsp
CMD_FILE                  = OutputCalibration.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/OutputCalibration.elf
...
DEFINES_STANDARD = -DMODEL=OutputCalibration -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o MW_PWM.o xcp_ext_mode.o OutputCalibration.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o mw_mbed_interface.o BufferedSerial.o stm32f7xx_init_board.o MW_Timer.o mbed_syscalls.o SysTickScheduler.o m3m4m4f_multitasking.o sys_arch.o rtiostream_serial_dma.o mw_mbed_pintable_interface.o xcp_platform_timer_mbed.o
...
%.o : $(START_DIR)/OutputCalibration_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/OutputCalibration_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/OutputCalibration_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/OutputCalibration_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/OutputCalibration_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
OutputCalibration.o : $(START_DIR)/OutputCalibration_ert_rtw/OutputCalibration.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/OutputCalibration_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
